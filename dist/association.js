...
function (_Association) {
  ...
  function SingleAssociation() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(SingleAssociation).apply(this, arguments));
  }
  ...
  (0, _createClass2["default"])(SingleAssociation, [{
    ...
    value: function parse() {
      ...
      properties = (_get2 = (0, _get4["default"])((0, _getPrototypeOf2["default"])(SingleAssociation.prototype), "parse", this)).call.apply(_get2, [this, properties].concat(args));
...
function (_SingleAssociation) {
  ...
  function BelongsTo() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(BelongsTo).apply(this, arguments));
  }
...
function (_Association2) {
  ...
  function HasMany() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(HasMany).apply(this, arguments));
  }

  (0, _createClass2["default"])(HasMany, [{
    key: "computeHasChanged",
    value: function computeHasChanged() {
      (0, _get4["default"])((0, _getPrototypeOf2["default"])(HasMany.prototype), "computeHasChanged", this).call(this);
    ...
    value: function parse() {
      ...
      properties = (_get3 = (0, _get4["default"])((0, _getPrototypeOf2["default"])(HasMany.prototype), "parse", this)).call.apply(_get3, [this, properties].concat(args));
    ...
    value: function setPristine() {
      (0, _get4["default"])((0, _getPrototypeOf2["default"])(HasMany.prototype), "setPristine", this).call(this);
