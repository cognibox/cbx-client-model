    ...
    function (_superclass) {
      ...
      (0, _createClass2["default"])(_class, null, [{
        ...
        value: function fetchAll() {
          ...
          var encodedConfig = this.encodeSyncConfig(config);
          return _axios["default"].get(url, encodedConfig).then(function (resp) {
            var result = {
              raw: resp.data
            };
      ...
      function _class() {
        ...
        Object.keys(_this.fields).forEach(function (fieldKey) {
          ...
          if (!(0, _helper.isInheritedFrom)(field, _attribute["default"])) return;
      ...
      (0, _createClass2["default"])(_class, [{
        ...
        value: function fetch() {
          ...
          url = url || this.buildUrl();
          var encodedConfig = this.constructor.encodeSyncConfig(config);
          return _axios["default"].get(url, encodedConfig).then(function (resp) {
