...
function (_HttpFieldMixin) {
  (0, _inherits2["default"])(CbxAttribute, _HttpFieldMixin);
  ...
  return CbxAttribute;
}((0, _http2["default"])((0, _validation2["default"])(_attribute["default"])));
...
function (_HttpFieldMixin2) {
  (0, _inherits2["default"])(CbxAssociation, _HttpFieldMixin2);
...
function (_HttpFieldMixin3) {
  (0, _inherits2["default"])(CbxBelongsTo, _HttpFieldMixin3);
...
function (_HttpFieldMixin4) {
  (0, _inherits2["default"])(CbxHasMany, _HttpFieldMixin4);
...
var CbxHasOne =
/*#__PURE__*/
function (_HttpFieldMixin5) {
  (0, _inherits2["default"])(CbxHasOne, _HttpFieldMixin5);
